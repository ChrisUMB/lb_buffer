#ifndef LB_WRITE_BUFFER_H
#define LB_WRITE_BUFFER_H
...
#ifndef LB_WRITE_BUFFER_NO_SAFETY
#define LB_WRITE_BUFFER_SAFETY
#endif
 ...
 * Will not do error checking if LB_WRITE_BUFFER_NO_SAFETY is defined.
 *
 * @param buffer A pointer to the LB_WriteBuffer to be initialized.                         <br>
 * If NULL and LB_WRITE_BUFFER_SAFETY, will return LB_WRITE_BUFFER_INIT_NO_BUFFER.                <br>
 * @param data A pointer to the data to be written to.                                      <br>
 * If NULL and LB_WRITE_BUFFER_SAFETY, will return LB_WRITE_BUFFER_INIT_DATA_NULL.                <br>
 * @param length The length of the data to be written.                                      <br>
 * If 0 and LB_WRITE_BUFFER_SAFETY, will return LB_WRITE_BUFFER_INIT_LENGTH_ZERO.                 <br>
 * @return LB_WriteBufferInitError An error code indicating the result of the initialization.
 */
inline LB_WriteBufferInitError lbWriteBufferInit(LB_WriteBuffer *buffer, const size_t length, void *data) {
#ifdef LB_WRITE_BUFFER_SAFETY
...
#ifdef LB_WRITE_BUFFER_SAFETY
inline LB_WriteBufferWriteError lbWriteBufferWriteSafety(const LB_WriteBuffer *buffer, const size_t length, const void *value) {
...
inline LB_WriteBufferWriteError lbWriteBufferWriteUnsafe(LB_WriteBuffer *buffer, const size_t length, const void *value) {
    memcpy(((uint8_t *) buffer->data) + buffer->position, value, length);
    buffer->position += length;
    return LB_WRITE_BUFFER_WRITE_NONE;
}

inline LB_WriteBufferWriteError lbWriteBufferWrite(LB_WriteBuffer *buffer, const size_t length, const void *value) {
#ifdef LB_WRITE_BUFFER_SAFETY
...
inline LB_WriteBufferWriteError lbWriteBufferWriteReversedUnsafe(LB_WriteBuffer *buffer, const size_t length,
                                                                 const void *value) {
...
inline LB_WriteBufferWriteError lbWriteBufferWriteReversed(LB_WriteBuffer *buffer, const size_t length, const void *value) {
#ifdef LB_WRITE_BUFFER_SAFETY
    const LB_WriteBufferWriteError e = lbWriteBufferWriteSafety(buffer, length, value);
    if (e) {
        return e;
...
inline LB_WriteBufferWriteError lbWriteBufferU8(LB_WriteBuffer *buffer, const uint8_t value) {
    return lbWriteBufferWrite(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferU8LE(LB_WriteBuffer *buffer, const uint8_t value) {
    return lbWriteBufferLE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferU8BE(LB_WriteBuffer *buffer, const uint8_t value) {
    return lbWriteBufferBE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferU16(LB_WriteBuffer *buffer, const uint16_t value) {
    return lbWriteBufferWrite(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferU16LE(LB_WriteBuffer *buffer, const uint16_t value) {
    return lbWriteBufferLE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferU16BE(LB_WriteBuffer *buffer, const uint16_t value) {
    return lbWriteBufferBE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferU32(LB_WriteBuffer *buffer, const uint32_t value) {
    return lbWriteBufferWrite(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferU32LE(LB_WriteBuffer *buffer, const uint32_t value) {
    return lbWriteBufferLE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferU32BE(LB_WriteBuffer *buffer, const uint32_t value) {
    return lbWriteBufferBE(buffer, sizeof(value), &value);
}


inline LB_WriteBufferWriteError lbWriteBufferU64(LB_WriteBuffer *buffer, const uint64_t value) {
    return lbWriteBufferWrite(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferU64LE(LB_WriteBuffer *buffer, const uint64_t value) {
    return lbWriteBufferLE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferU64BE(LB_WriteBuffer *buffer, const uint64_t value) {
    return lbWriteBufferBE(buffer, sizeof(value), &value);
}


inline LB_WriteBufferWriteError lbWriteBufferI8(LB_WriteBuffer *buffer, const int8_t value) {
    return lbWriteBufferWrite(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferI8LE(LB_WriteBuffer *buffer, const int8_t value) {
    return lbWriteBufferLE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferI8BE(LB_WriteBuffer *buffer, const int8_t value) {
    return lbWriteBufferBE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferI16(LB_WriteBuffer *buffer, const int16_t value) {
    return lbWriteBufferWrite(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferI16LE(LB_WriteBuffer *buffer, const int16_t value) {
    return lbWriteBufferLE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferI16BE(LB_WriteBuffer *buffer, const int16_t value) {
    return lbWriteBufferBE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferI32(LB_WriteBuffer *buffer, const int32_t value) {
    return lbWriteBufferWrite(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferI32LE(LB_WriteBuffer *buffer, const int32_t value) {
    return lbWriteBufferLE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferI32BE(LB_WriteBuffer *buffer, const int32_t value) {
    return lbWriteBufferBE(buffer, sizeof(value), &value);
}


inline LB_WriteBufferWriteError lbWriteBufferI64(LB_WriteBuffer *buffer, const int64_t value) {
    return lbWriteBufferWrite(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferI64LE(LB_WriteBuffer *buffer, const int64_t value) {
    return lbWriteBufferLE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferI64BE(LB_WriteBuffer *buffer, const int64_t value) {
    return lbWriteBufferBE(buffer, sizeof(value), &value);
}


inline LB_WriteBufferWriteError lbWriteBufferF32(LB_WriteBuffer *buffer, const float value) {
    return lbWriteBufferWrite(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferF32LE(LB_WriteBuffer *buffer, const float value) {
    return lbWriteBufferLE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferF32BE(LB_WriteBuffer *buffer, const float value) {
    return lbWriteBufferBE(buffer, sizeof(value), &value);
}


inline LB_WriteBufferWriteError lbWriteBufferF64(LB_WriteBuffer *buffer, const double value) {
    return lbWriteBufferWrite(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferF64LE(LB_WriteBuffer *buffer, const double value) {
    return lbWriteBufferLE(buffer, sizeof(value), &value);
}

inline LB_WriteBufferWriteError lbWriteBufferF64BE(LB_WriteBuffer *buffer, const double value) {
    return lbWriteBufferBE(buffer, sizeof(value), &value);
}
...
inline LB_WriteBufferWriteError lbWriteBufferNU8(LB_WriteBuffer *buffer, const float value) {
    const uint8_t normalized = (uint8_t) (value * ((float) UINT8_MAX) + 0.5f);
    LB_WRITE_BUFFER_NORMALIZED_UNSIGNED_SAFETY
    return lbWriteBufferWriteUnsafe(buffer, sizeof(normalized), &normalized);
}

inline LB_WriteBufferWriteError lbWriteBufferNU8LE(LB_WriteBuffer *buffer, const float value) {
    return lbWriteBufferNU8(buffer, value);
}

inline LB_WriteBufferWriteError lbWriteBufferNU8BE(LB_WriteBuffer *buffer, const float value) {
    return lbWriteBufferNU8(buffer, value);
}


inline LB_WriteBufferWriteError lbWriteBufferNU16(LB_WriteBuffer *buffer, const float value) {
    const uint16_t normalized = (uint16_t) (value * ((float) UINT16_MAX) + 0.5f);
    LB_WRITE_BUFFER_NORMALIZED_UNSIGNED_SAFETY
    return lbWriteBufferWriteUnsafe(buffer, sizeof(normalized), &normalized);
}

inline LB_WriteBufferWriteError lbWriteBufferNU16LE(LB_WriteBuffer *buffer, const float value) {
    return lbWriteBufferNU16(buffer, value);
}

inline LB_WriteBufferWriteError lbWriteBufferNU16BE(LB_WriteBuffer *buffer, const float value) {
    return lbWriteBufferNU16(buffer, value);
}

/*  Normalized integers utilizing more than 23 bits can carry more precision than a float.  */
inline LB_WriteBufferWriteError lbWriteBufferNU32(LB_WriteBuffer *buffer, const double value) {
    const uint32_t normalized = (uint32_t) (value * ((double) UINT32_MAX) + 0.5);
    LB_WRITE_BUFFER_NORMALIZED_UNSIGNED_SAFETY
    return lbWriteBufferWriteUnsafe(buffer, sizeof(normalized), &normalized);
}

inline LB_WriteBufferWriteError lbWriteBufferNU32LE(LB_WriteBuffer *buffer, const double value) {
    return lbWriteBufferNU32(buffer, value);
}

inline LB_WriteBufferWriteError lbWriteBufferNU32BE(LB_WriteBuffer *buffer, const double value) {
    return lbWriteBufferNU32(buffer, value);
}


inline LB_WriteBufferWriteError lbWriteBufferNU64(LB_WriteBuffer *buffer, const double value) {
    const uint64_t normalized = (uint64_t) (value * ((double) UINT64_MAX) + 0.5);
    LB_WRITE_BUFFER_NORMALIZED_UNSIGNED_SAFETY
    return lbWriteBufferWriteUnsafe(buffer, sizeof(normalized), &normalized);
}

inline LB_WriteBufferWriteError lbWriteBufferNU64LE(LB_WriteBuffer *buffer, const double value) {
    return lbWriteBufferNU64(buffer, value);
}

inline LB_WriteBufferWriteError lbWriteBufferNU64BE(LB_WriteBuffer *buffer, const double value) {
    return lbWriteBufferNU64(buffer, value);
}


inline LB_WriteBufferWriteError lbWriteBufferNI8(LB_WriteBuffer *buffer, const float value) {
    const int8_t normalized = (int8_t) (value * ((float) INT8_MAX) + 0.5f);
    LB_WRITE_BUFFER_NORMALIZED_SIGNED_SAFETY
    return lbWriteBufferWriteUnsafe(buffer, sizeof(normalized), &normalized);
}

inline LB_WriteBufferWriteError lbWriteBufferNI8LE(LB_WriteBuffer *buffer, const float value) {
    return lbWriteBufferNI8(buffer, value);
}

inline LB_WriteBufferWriteError lbWriteBufferNI8BE(LB_WriteBuffer *buffer, const float value) {
    return lbWriteBufferNI8(buffer, value);
}


inline LB_WriteBufferWriteError lbWriteBufferNI16(LB_WriteBuffer *buffer, const float value) {
    const int16_t normalized = (int16_t) (value * ((float) INT16_MAX) + 0.5f);
    LB_WRITE_BUFFER_NORMALIZED_SIGNED_SAFETY
    return lbWriteBufferWriteUnsafe(buffer, sizeof(normalized), &normalized);
}

inline LB_WriteBufferWriteError lbWriteBufferNI16LE(LB_WriteBuffer *buffer, const float value) {
    return lbWriteBufferNI16(buffer, value);
}

inline LB_WriteBufferWriteError lbWriteBufferNI16BE(LB_WriteBuffer *buffer, const float value) {
    return lbWriteBufferNI16(buffer, value);
}


inline LB_WriteBufferWriteError lbWriteBufferNI32(LB_WriteBuffer *buffer, const double value) {
    const int32_t normalized = (int32_t) (value * ((double) INT32_MAX) + 0.5);
    LB_WRITE_BUFFER_NORMALIZED_SIGNED_SAFETY
    return lbWriteBufferWriteUnsafe(buffer, sizeof(normalized), &normalized);
}

inline LB_WriteBufferWriteError lbWriteBufferNI32LE(LB_WriteBuffer *buffer, const double value) {
    return lbWriteBufferNI32(buffer, value);
}

inline LB_WriteBufferWriteError lbWriteBufferNI32BE(LB_WriteBuffer *buffer, const double value) {
    return lbWriteBufferNI32(buffer, value);
}


inline LB_WriteBufferWriteError lbWriteBufferNI64(LB_WriteBuffer *buffer, const double value) {
    const int64_t normalized = (int64_t) (value * ((double) INT64_MAX) + 0.5);
    LB_WRITE_BUFFER_NORMALIZED_SIGNED_SAFETY
    return lbWriteBufferWriteUnsafe(buffer, sizeof(normalized), &normalized);
}

inline LB_WriteBufferWriteError lbWriteBufferNI64LE(LB_WriteBuffer *buffer, const double value) {
    return lbWriteBufferNI64(buffer, value);
}

inline LB_WriteBufferWriteError lbWriteBufferNI64BE(LB_WriteBuffer *buffer, const double value) {
    return lbWriteBufferNI64(buffer, value);
}
#ifdef __cplusplus
}
...
#ifdef LB_WRITE_BUFFER_IMPLEMENTATION
#ifdef __cplusplus
extern "C" {
#endif
LB_WriteBufferInitError lbWriteBufferInit(LB_WriteBuffer *buffer, size_t length, void *data);
#ifdef LB_WRITE_BUFFER_SAFETY
LB_WriteBufferWriteError lbWriteBufferWriteSafety(const LB_WriteBuffer *buffer, size_t length, const void *value);
#endif
